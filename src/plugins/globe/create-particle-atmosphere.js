...
export default function createParticleAtmosPhere () {
  ...
  // lightLeft.add(new THREE.Mesh(LightSphere, new THREE.MeshBasicMaterial({color: 0x2a00ff})));
  ...
  // lightRight.add(new THREE.Mesh(LightSphere, new THREE.MeshBasicMaterial({color: 0x9d00ff})));
  ...
  // lightTop.add(new THREE.Mesh(LightSphere, new THREE.MeshBasicMaterial({color: 0x9d00ff})));
